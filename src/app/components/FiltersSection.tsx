    ...
    return (
      <div className="border-t border-gray-200 bg-white px-4 py-3">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6">
          <div>
            ...
            <div className="relative">
              <select className="w-full appearance-none rounded-full border border-gray-300 bg-white px-4 py-2 pe-10 text-sm text-gray-600 cursor-pointer hover:border-gray-400 focus:border-teal-500 focus:outline-none">
        ...
        <div className="mt-3 flex justify-end gap-2">
          ...
          <Button className="bg-teal-500 hover:bg-teal-600 h-8 px-4 text-sm rounded-full">
            {t("apply")}
          </Button>
        </div>
      </div>
    ...
    <div className="p-4 border-t border-gray-200 bg-white">
      ...
      <div className="flex justify-end gap-2">
        <Button
          variant="outline"
          size="sm"
          className="h-9 px-5 text-sm rounded-full border-gray-300 hover:bg-gray-50"
        >
          {t("reset")}
        </Button>
