      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center">
            <Button
              variant="ghost"
              className="h-11 px-4 text-sm text-gray-700 hover:text-gray-900 hover:bg-transparent"
            >
              {t("dashboard")}
            </Button>
            <Button
              variant="ghost"
              className="h-11 px-4 text-sm text-gray-700 hover:text-gray-900 hover:bg-transparent gap-1"
            >
            ...
            <button
              ...
              className={`h-11 px-4 text-sm gap-1 font-medium transition-colors focus-visible:outline-none border-b-2 relative rounded-none hover:bg-transparent inline-flex items-center justify-center bg-transparent outline-none ${
